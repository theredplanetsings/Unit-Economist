...
Run this script to train models, evaluate performance, and generate visualisations.
"""
...
def main():
    ...
    # 5. Visualisations
    logger.info("Step 5: Creating visualisations...")
    visualizer = ModelVisualizer()
    
    # Data distribution plots
    visualizer.plot_data_distribution(df, "visualisations/data_distribution.png")
    
    # Model comparison plots
    visualizer.plot_model_comparison(comparison_df, "visualisations/model_comparison.png")
    ...
    visualizer.plot_predictions_vs_actual(
        ...
        f"visualisations/{best_name}_predictions.png"
    )
    ...
    if best_name in ['random_forest', 'gradient_boosting', 'xgboost', 'lightgbm']:
        ...
        visualizer.plot_feature_importance(
            ...
            save_path=f"visualisations/{best_name}_feature_importance.png"
        )
    
    # Price trends analysis
    visualizer.plot_price_trends(df, "visualisations/price_trends.png")
    
    # Interactive map (if running in Jupyter or with display capability)
    try:
        visualizer.create_interactive_rent_map(df, "visualisations/rent_map.html")
    ...
    logger.info("Check the 'visualisations' folder for plots and analysis")
...
if __name__ == "__main__":
    ...
    print("Check the 'visualisations' folder for analysis plots")
